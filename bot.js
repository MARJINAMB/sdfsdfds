    ...
    client.on('channelDelete', async channel => {
        ...
        if (!hgK) return;
            if (channel.type === "text") {
                ...
                .setColor(3066993)
                .setAuthor(channel.guild.name, channel.guild.iconURL)
                .setDescription(`${channel.name} kanalı silindi. @everyone _(metin kanalı)_`)
                .setFooter(`ID: ${channel.id}`)
                hgK.send({embed});
            };
            if (channel.type === "voice") {
                ...
                .setColor(3066993)
                .setAuthor(channel.guild.name, channel.guild.iconURL)
                .setDescription(`${channel.name} kanalı silindi.@everyone  _(sesli kanal)_`)
                .setFooter(`ID: ${channel.id}`)
                hgK.send({embed});
            }
...
client.login(ayarlar.token); // skdljfjsdfsd
...
client.on('message', async message => {
  ...
  if (message.content.toLowerCase().includes(`tank sistemi`)) {
   ...
   if (message.content.toLowerCase() === "-ip") {
      message.channel.send('Play.SoulCubeNw.Com')
     }
  })
...
///////////// 7/24 SES KANALINDA KALMA ////////////////////

client.on('ready', ()=>{
client.channels.get('697059202769879040').join()
})
